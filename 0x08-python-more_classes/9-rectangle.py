...
class Rectangle():
    ...
    def perimeter(self):
        """ Returns rectangle perimeter; 0 if width or height is 0"""
        if (self.__width == 0 or self.__height == 0):
            return 0
        else:
    ...
    def square(cls, size=0):
        """
        Returns new Rectangle object where:
        width == height == size
        """
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        rect_1 and rect_2 must be instances of Rectangle
        Return rect_1 if areas are the same
        """
